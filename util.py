...
def insertBlockChainOrder(order_details):
    ...
    payload = {
        ...
        "billing_first_name": billing['first_name'] if order_details['first_name'] else "",
        "billing_last_name": billing['last_name'] if order_details['last_name'] else "",
        ...
        "order_key": "",
        "billing_company": billing['company'] if order_details['company'] else "",
        "billing_address_1": billing['address_1'] if order_details['address_1'] else "",
        "billing_address_2": billing['address_2'] if order_details['address_2'] else "",
        "billing_city": billing['city'] if order_details['city'] else "",
        "billing_state": billing['state'] if order_details['state'] else "",
        "billing_postcode": billing['postcode'] if order_details['postcode'] else "",
        "billing_country": billing['country'] if order_details['country'] else "",
        "billing_email": billing['email'] if order_details['email'] else "",
        "billing_phone": billing['phone'] if order_details['phone'] else "",
        "shipping_first_name": shipping['first_name'] if order_details['first_name'] else "",
        "shipping_last_name": shipping['last_name'] if order_details['last_name'] else "",
        "shipping_company": shipping['company'] if order_details['company'] else "",
        "shipping_address_1": shipping['address_1'] if order_details['address_1'] else "",
        "shipping_address_2": shipping['address_2'] if order_details['address_2'] else "",
        "shipping_city": shipping['city'] if order_details['city'] else "",
        "shipping_state": shipping['state'] if order_details['state'] else "",
        "shipping_postcode": shipping['postcode'] if order_details['postcode'] else "",
        "shipping_country": shipping['country'] if order_details['country'] else "",
